...
# === Host-side Torch port setup ===
ENV_FILE="./torch_ports.env"

echo
echo "=============================================="
echo "  ⚙️  Space Engineers Torch Port Configuration"
echo "=============================================="
echo
echo "This script defines the network ports that will be used"
echo "for your Torch + Space Engineers dedicated server."
...
cat > "$ENV_FILE" <<EOF
# Torch / Space Engineers Port Configuration
# Generated $(date)
...
echo "      docker build -t torch-server ."
echo

...
docker cp "$ENV_FILE" "${CONTAINER_NAME}:/home/wine/scripts/torch_ports.env"

# 5️⃣ Run setup inside container before attaching
echo
echo "⚙️ Running initial Torch + Space Engineers setup inside container..."
